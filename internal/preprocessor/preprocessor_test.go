	...
	tests := []struct {
	...
	}{
		{
			...
			wantInfo: enumInfo{
				...
				Variants: []enumVariant{
					{Name: "Red", ConstructorName: "ColorRed", ConcreteType: "_gogo_gen_Color_Red"},
					{Name: "Green", ConstructorName: "ColorGreen", ConcreteType: "_gogo_gen_Color_Green"},
					{Name: "Blue", ConstructorName: "ColorBlue", ConcreteType: "_gogo_gen_Color_Blue"},
				},
			},
		...
		},
		{
			...
			wantInfo: enumInfo{
				...
				Variants: []enumVariant{
					{Name: "Red", ConstructorName: "ColorRed", ConcreteType: "_gogo_gen_Color_Red"},
					{Name: "RGB", ConstructorName: "ColorRGB", ConcreteType: "_gogo_gen_Color_RGB", Fields: []enumField{{Name: "r", Type: "byte"}, {Name: "g", Type: "byte"}, {Name: "b", Type: "byte"}}},
				},
			},
			want: strings.Join([]string{
...
`),
		...
		},
		{
			...
			want: strings.Join([]string{
				...
				"",
				"func describe(color Color) string {",
				"\tswitch _gogo_gen_match_0 := color; _gogo_gen_match_0 {",
				"\tcase ColorRed:",
				"\t\treturn \"red\"",
				"\tcase ColorGreen:",
				"\t\treturn \"green\"",
		...
		},
		{
			...
			want: strings.Join([]string{
				...
				"",
				"func describe(color Color) string {",
				"\tswitch _gogo_gen_match_0 := (color).(type) {",
				"\tcase _gogo_gen_Color_Red:",
				"\t\treturn \"red\"",
				"\tcase _gogo_gen_Color_RGB:",
				"\t\tr, g, b := _gogo_gen_match_0.r, _gogo_gen_match_0.g, _gogo_gen_match_0.b",
				"\t\treturn string([]byte{r, g, b})",
				"\tdefault:",
				"\t\treturn \"unknown\"",
				"\t}",
