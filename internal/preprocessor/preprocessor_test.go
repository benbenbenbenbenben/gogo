	...
	tests := []struct {
	...
	}{
		{
			...
			wantInfo: enumInfo{
				...
				Variants: []enumVariant{
					{Name: "Red", ConstructorName: "ColorRed", ConcreteType: "__gogo_internal_Color_Red"},
					{Name: "Green", ConstructorName: "ColorGreen", ConcreteType: "__gogo_internal_Color_Green"},
					{Name: "Blue", ConstructorName: "ColorBlue", ConcreteType: "__gogo_internal_Color_Blue"},
				},
			},
		...
		},
		{
			...
			wantInfo: enumInfo{
				...
				Variants: []enumVariant{
					{Name: "Red", ConstructorName: "ColorRed", ConcreteType: "__gogo_internal_Color_Red"},
					{Name: "RGB", ConstructorName: "ColorRGB", ConcreteType: "__gogo_internal_Color_RGB", Fields: []enumField{{Name: "r", Type: "byte"}, {Name: "g", Type: "byte"}, {Name: "b", Type: "byte"}}},
				},
			},
			want: strings.Join([]string{
...
`),
		...
		},
		{
			...
			want: strings.Join([]string{
				...
				"",
				"func describe(color Color) string {",
				"\tswitch __gogo_internal_match_0 := color; __gogo_internal_match_0 {",
				"\tcase ColorRed:",
				"\t\treturn \"red\"",
				"\tcase ColorGreen:",
				"\t\treturn \"green\"",
		...
		},
		{
			...
			want: strings.Join([]string{
				...
				"",
				"func describe(color Color) string {",
				"\tswitch __gogo_internal_match_0 := (color).(type) {",
				"\tcase __gogo_internal_Color_Red:",
				"\t\treturn \"red\"",
				"\tcase __gogo_internal_Color_RGB:",
				"\t\tr, g, b := __gogo_internal_match_0.r, __gogo_internal_match_0.g, __gogo_internal_match_0.b",
				"\t\treturn string([]byte{r, g, b})",
				"\tdefault:",
				"\t\treturn \"unknown\"",
				"\t}",
